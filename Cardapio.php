...
<main>
    ...
    <div>
        <h2>Chocolate</h2>
        <img src="imagens/ChocolateC.jpg" alt="">
        <p>Massa de chocolate com recheio de chocolate fudge e cobertura de brigadeiro com chocolate em cubinhos.</p>
        <label>Adicionar </label><input type="text" name="Chocolate"><label> ao carrinho</label>
    </div>
    <div>
        <h2>Leite Ninho</h2>
        <img src="imagens/leite.jpg" alt="">
    ...
    <div>
        <h2>Baunilha</h2>
        <img src="imagens/baunilha.jpg" alt="">
    ...
    <div>
        <h2>Prestígio</h2>
        <img src="imagens/prestigio.jpg" alt="">
    ...
    <div>
        <h2>Red Velvet</h2>
        <img src="imagens/re3d velvet.jpg" alt="">
    ...
    <div>
        <h2>Cenoura</h2>
        <img src="imagens/cenoura.jpg" alt="">
